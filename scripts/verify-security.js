...
const sensitiveVars = [
  ...
  'LAAC_COMPLIANT_COUNTRIES',
  'LAAC_ALTERNATIVE_COUNTRIES',
  'LAAC_OUT_OF_SCOPE_DIVISION_ID'
];
...
process.env.LAAC_COMPLIANT_COUNTRIES = 'SENSITIVE_COUNTRIES_SHOULD_NOT_BE_IN_BUNDLE';
process.env.LAAC_ALTERNATIVE_COUNTRIES = 'SENSITIVE_COUNTRIES_SHOULD_NOT_BE_IN_BUNDLE';
process.env.LAAC_OUT_OF_SCOPE_DIVISION_ID = 'SENSITIVE_DIVISION_ID_SHOULD_NOT_BE_IN_BUNDLE';
